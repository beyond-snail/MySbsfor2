...
import com.zfsbswx.activity.SaleMainActivity;
...
import com.zfsbswx.model.OperatorBean;
...
public class LoginAction {
    ...
    public void loginAction() {
        ...
        MyApplication.getInstance().getSbsAction().Login(mContext, StringUtils.getSerial1(), "", "", new ActionCallbackListener<LoginApiResponse>() {
            @Override
...
//                }
    ...
    public void loginAction(final String username, final String password) {
        ...
        MyApplication.getInstance().getSbsAction().Login(mContext, StringUtils.getSerial1(), username, password, new ActionCallbackListener<LoginApiResponse>() {
            @Override
            public void onSuccess(LoginApiResponse data) {
                //判断当前的操作员是否存在返回列表中
