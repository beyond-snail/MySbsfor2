...
public class Config {
    ...
    public final static String SBS_URL = "http://api1.eboss007.com/api/index.php";//"http://api.eboss007.com/api/index.php";//"http://sbs.xun-ao.com/dtrade/api/";//"http://wqapi.xun-ao.com/";// "http://wqapi.xun-ao.com/";//"http://sbs.xun-ao.com/dtrade/api/";//"http://121.40.224.25:83/dtrade/api/";//"http://sbs.xun-ao.com/dtrade/api/";//"http://www.eboss007.com/dtrade/api/";//"http://wqapi.xun-ao.com/index.php/api/index";
    ...
    public static int DEFAULT_APP_TYPE = APP_Richer_e;
