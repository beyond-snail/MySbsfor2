...
public class RecordInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextView tj;
    private com.zfsbswx.adapter.MyRecordsAdapter adapter;
    private int index = 0;
...
//		testData();
    ...
    private void initAdapter() {
        ...
        adapter = new com.zfsbswx.adapter.MyRecordsAdapter(RecordInfoActivity.this, allData, R.layout.activity_record_item);
