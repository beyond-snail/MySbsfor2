...
import com.zfsbswx.model.ActivateApiResponse;
...
import static com.zfsbswx.config.Constants.REQUEST_CAPTURE_ALY;
import static com.zfsbswx.config.Constants.REQUEST_CAPTURE_QB;
import static com.zfsbswx.config.Constants.REQUEST_CAPTURE_WX;
import static com.zfsbswx.config.Constants.REQUEST_CASH;
...
//                ToastUtils.CustomShow(ZfPayActivity.this, error);
    ...
    private void FyWxPay1(String code) {
        ...
        printerData.setClientOrderNo(CommonFunc.getNewClientSn(this, printerData.getPayType()));
        fybat.pay1(code, Constants.PAY_FY_WX, printerData.getClientOrderNo(), CommonFunc.recoveryMemberInfo(this).getRealMoney());
    }
    ...
    private void FyAlyPay1(String code) {
        ...
        printerData.setClientOrderNo(CommonFunc.getNewClientSn(this, printerData.getPayType()));
        fybat.pay1(code, Constants.PAY_FY_ALY, printerData.getClientOrderNo(), CommonFunc.recoveryMemberInfo(this).getRealMoney());
    }
    ...
    private void setQbPay1(ZfQbResponse data, String orderNo, String time, String traceNum) {
        ...
        printerData.setTerminalId(StringUtils.getSerial1());
...
//    }
    ...
    private void setFySmPay1(FyMicropayResponse data) {
        ...
        printerData.setTerminalId(StringUtils.getTerminalNo(StringUtils.getSerial1()));
        printerData.setOperatorNo((String) SPUtils.get(this, Constants.USER_NAME, ""));
