...
//            }
    ...
    //流水上送
    private  void transUploadAction(final Context context, final SbsPrinterData recordData) {
        ...
        sbsAction.transUpload(context, transUploadRequest, new ActionCallbackListener<TransUploadResponse>() {
            @Override
